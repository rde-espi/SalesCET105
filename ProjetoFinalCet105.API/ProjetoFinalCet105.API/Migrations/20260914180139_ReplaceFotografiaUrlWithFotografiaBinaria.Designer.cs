...
namespace ProjetoFinalCet105.API.Migrations
{
    ...
    [Migration("20260914180139_ReplaceFotografiaUrlWithFotografiaBinaria")]
    partial class ReplaceFotografiaUrlWithFotografiaBinaria
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjetoFinalCet105.API.Entities.Despesa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProjetoFinalCet105.API.Entities.PermissaoAdminTemporaria", b =>
                {
                    ...
                    b.Property<string>("RevogadaPorUserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ProjetoFinalCet105.API.Entities.PermissaoAdminTemporaria", b =>
                {
                    ...
                    b.HasOne("ProjetoFinalCet105.API.Entities.User", "RevogadaPorUser")
                        .WithMany()
                        .HasForeignKey("RevogadaPorUserId")
                        .OnDelete(DeleteBehavior.Restrict);

...
namespace ProjetoFinalCet105.API.Controllers
{
    ...
    public class FaturasController : ControllerBase
    {
        ...
        public FaturasController(CreateFaturaUseCase createFaturaUseCase, GetFaturaByIdUseCase getFaturaByIdUseCase, GetFaturasUseCase getFaturasUseCase,
        ...
        public async Task<IActionResult> Create(int marcacaoId)
        {
            ...
            var resultado = await _createFaturaUseCase.ExecuteAsync(
                marcacaoId,
                userId,
                isFuncionario,
                isAdmin);
        ...
        public async Task<IActionResult> GetById(int id)
        {
            ...
            var resultado =
                await _getFaturaByIdUseCase.ExecuteAsync(
                    id,
                    userId,
                    isCliente,
                    isFuncionario,
    ...
    [FromQuery] string? estado = null)
        {
            ...
            var resultado =
                await _getFaturasUseCase.ExecuteAsync(
                    userId,
                    isCliente,
                    isFuncionario,
                    isAdmin,
        ...
        public async Task<IActionResult> GetPdf(int id)
        {
            ...
            var pdfBytes =
                _faturaPdfService.GerarPdf(fatura);

            var nomeFicheiro =
                $"Fatura-{fatura.Numero.Replace("/", "-")}.pdf";
